    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text variant="bodyMedium" style={styles.paragraph}>
          Patrick Travel Services ("we", "our", or "us") is committed to
        ...
        <Text variant="bodyMedium" style={styles.paragraph}>
          ...
          (passports, IDs, travel documents){'\n'}• Chat messages with advisors
          {'\n\n'}
        ...
        <Text variant="bodyMedium" style={styles.paragraph}>
          We use your information to:{'\n\n'}• Provide immigration consultation
        ...
        <Text variant="bodyMedium" style={styles.paragraph}>
          ...
          encryption for data transmission (HTTPS/TLS){'\n'}• Encrypted storage
        ...
        <Text variant="bodyMedium" style={styles.paragraph}>
          ...
          {'\n'}• <Text style={styles.bold}>Rectification:</Text> Update
          incorrect information{'\n'}• <Text style={styles.bold}>Erasure:</Text>{' '}
          Delete your account and data{'\n'}•{' '}
          <Text style={styles.bold}>Data Portability:</Text> Export your data in
          JSON format{'\n'}• <Text style={styles.bold}>Object:</Text> Opt-out of
        ...
        <Text variant="bodyMedium" style={styles.paragraph}>
          ...
          (typically 7 years for immigration documents){'\n\n'}
          When you delete your account, we permanently erase your personal data
          within 30 days, except where legal obligations require retention.
        </Text>
        ...
        <Text variant="bodyMedium" style={styles.paragraph}>
          ...
          outside your country of residence. We ensure appropriate safeguards
          are in place to protect your data in compliance with GDPR.
        </Text>
